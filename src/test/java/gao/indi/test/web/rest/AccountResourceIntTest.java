...
import gao.indi.test.domain.Authority;
import gao.indi.test.domain.User;
import gao.indi.test.repository.AuthorityRepository;
import gao.indi.test.repository.UserRepository;
import gao.indi.test.security.AuthoritiesConstants;
import gao.indi.test.service.MailService;
import gao.indi.test.service.UserService;
import gao.indi.test.service.dto.PasswordChangeDTO;
import gao.indi.test.service.dto.UserDTO;
import gao.indi.test.web.rest.errors.ExceptionTranslator;
import gao.indi.test.web.rest.vm.KeyAndPasswordVM;
import gao.indi.test.web.rest.vm.ManagedUserVM;
